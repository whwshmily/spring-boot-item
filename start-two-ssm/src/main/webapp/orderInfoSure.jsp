...
<div id="bodyPart">
	...
	<div class="List_cart">
		...
		<div class="cart_table">		
			...
			<div id="part_cart">
				<div class="o_show">
				   <h1><span style="margin-right: 700px;">商品清单</span><a  href="/category/myCart" id="backCart">返回修改购物车</a></h1>
				   <div class="middle">
					   <table width="100%" cellspacing="0" cellpadding="0" class="Table">
						...
						<c:forEach items="${carts}" var="c">
							<tr class="align_Center">
								<td style="padding: 5px 0pt;">${c.product.product_id}</td>
								<td class="align_Left">
									<div id="c_img"><a href="ipad.jsp"><img src="/${c.product.picture}" style="height: 80px"></a></div>
									<a href="#">${c.product.name}</a>
									<div><span class="tip_bag">[赠品]</span>无 <font color="red"></font></div>

								</td>
								<td><span class="price">${c.product.lower_price}</span></td>
								<td>￥0.00</td>
								<td>0</td>
								<td>现货</td>
								<td>${c.product_num}</td>
			...
			<div id="ware_info">
				...
				<div class="middle">
					<ul id="part_info">
						<li style="padding-bottom: 5px;" class="info1">商品金额：${totalCount}元 + 运费：0.00元 - 优惠券：<span id="price_coupon">0.00</span>元 - 礼品卡：<span id="price_coupon">0.00</span>元 - 返现：0.00元
						<br>
						</li>
						...
						<li style="width: 100%; overflow: hidden;" class="info2">
							 <table cellspacing="0" cellpadding="0" width="100%">
								<tr>
								  ...
								  <td style="text-align: right; font-size: 15px;"><b>应付总额：<font color="red">￥${totalCount}</font> 元</b></td>
							   </tr>
								<tr>
