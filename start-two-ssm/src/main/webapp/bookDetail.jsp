...
<%@include file="head.jsp"%>
	...
	<div class="w">
		<div class="crumb">
			 <a href="/category/showAllOneLevelCategory">首页</a>
			 &nbsp;&gt;&nbsp;
			 <a href="/category/showAllOneLevelCategory">图书</a>
			 &nbsp;&gt;&nbsp;
			 <a href="/category/showAllTwoLevelCategory?id=${category.category_id}">${category.name}</a>
			 &nbsp;&gt;&nbsp;
	...
	<div class="main">
		...
		<div class="right-extra">
			...
			<div id="name">
				<h1>${product.description}<font id="advertiseWord" style="color: rgb(255, 0, 0);"></font></h1>
			</div>
			...
			<ul id="summary">
					<li>作　　者： ${product.author} 著 王祖宁，刘寅龙 译 </li>
					<li>出 版 社： ${product.publishing}</li>
					<li>ＩＳＢＮ：${product.isbn}</li>
					<li>出版时间：<fmt:formatDate value="${product.publish_time}" pattern="yyyy-MM-dd"></fmt:formatDate> </li>
					<li>版　　次：${product.which_edtion}</li>
					<li>页　　数：${product.total_page}</li>
					<li>装　　帧：${product.bind_layout}</li>
					<li>开　　本：${product.book_size}</li>
					<li id="market-price">市&nbsp;场&nbsp;价：<s>￥${product.fixed_price}</s><span class="pid">商品编号：${product.print_INT}</span></li>
					<li>
				    	<div class="fl">
							京&nbsp;东&nbsp;价：
