...
<div class="container">
    <ol class="breadcrumb">
        ...
        <li><a href="../list?category.id=${product.category.id}">${product.category.name}</a></li>
        <li>${product.name}</li>
        <li>属性值管理</li>
    </ol>
</div>
                ...
                <div class="form-group">
                    <c:forEach items="${propertyValues}" var="p" varStatus="vs">
                        ...
                        <div class="col-sm-4" style="margin-bottom: 10px;">
                            <input type="hidden" name="propertyValues[${vs.index}].id" value="${p.id}">
                            <input type="text" class="form-control" id="name${vs.count}" name="propertyValues[${vs.index}].value"
