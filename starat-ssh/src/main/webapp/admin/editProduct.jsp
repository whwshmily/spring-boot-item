...
<div class="container" >
    <ol class="breadcrumb">
        <li><a href="/admin/category/page">分类管理</a></li>
        <li><a href="/admin/product/page?category.id=${category.id}">${category.name}</a></li>
		<li>${product.name}</li>
    </ol>
</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="subTitle" name="product.sub_title"
                                   placeholder="请输入产品小标题" value="${product.sub_title}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="originalPrice" name="product.o_price"
                                   placeholder="请输入原价格" value="${product.o_price}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nowPrice" name="product.n_price"
                                   placeholder="请输入现价格" value="${product.n_price}">
                        </div>
                    </div>
                    <div class="form-group">
