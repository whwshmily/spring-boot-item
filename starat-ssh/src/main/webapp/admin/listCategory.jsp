...
<%--                <jsp:useBean id="categories" scope="request" type="java.util.List"/>--%>
                <c:forEach items="${pageCategory.list}" var="c" varStatus="vs">
                    <tr>
                        <th scope="row">${c.id}</th>
                        <td>${c.recommend}</td>
                        <td>${c.name}</td>
                        <td><a href="../property/list?category.id=${c.id}"><span class="glyphicon glyphicon-list-alt"></span></a></td>
                        <td><a href="/admin/product/page?category.id=${c.id}"><span class="glyphicon glyphicon-shopping-cart"></span></a></td>
                        <td><a href="edit?category.id=${c.id}"><span class="glyphicon glyphicon-edit"></span></a></td>
                        <td><a href="delete?category.id=${c.id}" class="delete-button"><span class="glyphicon glyphicon-trash"></span></a></td>
                    </tr>
                </c:forEach>
        </tbody>
    </table>
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="add-form" action="add" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="recommend" name="category.recommend"
